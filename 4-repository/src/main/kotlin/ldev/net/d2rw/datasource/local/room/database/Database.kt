...
package ldev.net.d2rw.datasource.local.room.database
...
import ldev.net.d2rw.datasource.local.room.dao.GemDao
import ldev.net.d2rw.datasource.local.room.entity.Gem

@Database(entities = [(Gem::class)], version = 1, exportSchema = false)
abstract class D2RWDatabase : RoomDatabase() {

    abstract fun gemDao(): GemDao

    companion object {
        fun buildDatabase(context: Context): D2RWDatabase {
            return Room.databaseBuilder(context,
                    D2RWDatabase::class.java, "d2-database.db")
