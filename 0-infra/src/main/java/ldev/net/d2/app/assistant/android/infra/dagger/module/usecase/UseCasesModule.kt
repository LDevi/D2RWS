...
package ldev.net.d2.app.assistant.android.infra.dagger.module.usecase
...
class UseCasesModule {
    ...
    @Provides
    fun provideSearchForRunesUseCase(runeService: RuneService): SearchForRunesUseCase = SearchForRunesUseCaseImpl(runeService)
}
