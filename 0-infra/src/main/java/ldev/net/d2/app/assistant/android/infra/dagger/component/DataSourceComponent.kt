...
import ldev.net.d2.app.assistant.android.infra.dagger.module.repository.DataSourceModule
import ldev.net.d2.app.assistant.android.infra.dagger.module.repository.DatabaseModule
...
@SingleIn(DataSourceComponent::class)
@Component(dependencies = [AppComponent::class], modules = [DatabaseModule::class, DataSourceModule::class])
interface DataSourceComponent {
    var gemDataSource: GemDataSource
}