...
import ldev.net.d2.app.assistant.android.infra.dagger.module.presentation.PresentationModule
import ldev.net.d2.app.assistant.android.infra.dagger.scope.SingleIn

@SingleIn(PresentationComponent::class)
@Component(dependencies = [AppCoreComponent::class], modules = [PresentationModule::class])
interface PresentationComponent {
    ...
    interface Builder {
        ...
        fun appCoreComponent(appCoreComponent: AppCoreComponent): Builder
        fun build(): PresentationComponent
    }

    fun inject(appInfra: AppInfra)
}