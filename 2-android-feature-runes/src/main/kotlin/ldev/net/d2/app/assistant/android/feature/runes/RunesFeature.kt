...
package ldev.net.d2.app.assistant.android.feature.runes
...
class RunesFeature {
    ...
    fun init(application: Application, searchForRunesUseCase: SearchForRunesUseCase): DispatchingAndroidInjector<Activity> {

        DaggerPresentationAppComponent.builder()
                .application(application)
                .searchForRunesUseCase(searchForRunesUseCase)
                .build()
                .inject(this)
